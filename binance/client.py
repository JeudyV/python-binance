...
class Client(object):
    ...
    # API_URL = 'https://testnet-dex-asiapacific.binance.org/api'
    # WITHDRAW_API_URL = 'https://testnet-dex-asiapacific.binance.org/wapi'
    # WEBSITE_URL = 'https://testnet-dex-asiapacific.binance.org'
    API_URL = 'https://testnet.binancefuture.com/api'
    WITHDRAW_API_URL = 'https://testnet.binancefuture.com/wapi'
    WEBSITE_URL = 'https://testnet.binancefuture.com'
